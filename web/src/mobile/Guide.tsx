...
const LOOP: Array<{ k: string; t: string; d: string }> = [
  { k: "召", t: "召对 · 人治之门", d: "你只与身边的随侍太监直接说话。要见大臣，命随侍传召——大臣趋入奏对，点击「奏对完成」后由随侍送其告退。随侍是你的耳目与顾问，也有私心。" },
  ...
  { k: "柄", t: "查档 · 阴私与厂卫", d: "点任何人脸开其卷宗：令东厂密查可掘出把柄（贪墨/朋党/通敌），握柄则可挟制——胁其归附、逼令致仕、或罗织下狱。然清官难陷、陷则反噬。以威驭下之道。" },
  { k: "宫", t: "后宫 · 内宠与枕席", d: "命礼部/司礼监采选秀女、降诏册封位份。宠妃会吹枕边风荐党、进谗清流、彼此争宠；得宠妃与权阉还可结对食，内外勾连。中宫周皇后开局即在。" },
];
