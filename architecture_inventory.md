...
| 类别 | 数量 | 说明 |
|------|------|------|
| 后端 Python 顶层模块 | 90 | `ming_sim/*.py`（2026-06-27 复核：原记 74 已 drift +16，含 quest_*/assignment/* 等子系统） |
...
> **2026-06-27 架构复核**：90 个后端模块中，quest_*/assignment_* 共 7 个目前无父级入口
> （既不在本清单的 16 子系统里，也未登记 MODULE/PIPELINE_REGISTRY）。这 7 个是
> "压缩到 5 入口"战略的最大未决项——需决定归入 召对/诏旨 还是单列为第 17 子系统。
> 详见 `docs/architecture-review-2026-06-27.md`（如已生成）。
