...
_SPECS: Tuple[WebPayloadRouteSpec, ...] = (
    ...
    _route("/api/policy_center", ("GET",), "panel", compact=True, risk="medium"),
    _route("/api/fiscal_center", ("GET",), "panel", compact=True, risk="medium"),
    _route("/api/statecraft_center", ("GET",), "panel", compact=True, risk="medium"),
