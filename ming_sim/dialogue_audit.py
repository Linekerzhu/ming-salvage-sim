...
- 例外：secret_order 包含一次性密令建档，以及对既有密令的明确催办/加急/即核动作；office_change 是一次性任免动作。只有玩家本轮明确“下密令/密旨/命某人暗查某事”、明确要求某条密令“催办/加急/本月即核”，或明确任命/授官/补某人某缺时，才可在没有 pending_action 时返回 phase=confirm 并允许即时落库。
...
- secret_order：下达新密令时，只有玩家明确下达密令/密旨，且能从玩家原话读出承办人或承办对象、暗查/取证/盯梢等任务目标，才可 allow=true 且 phase=confirm。催办既有密令时，tool_action.kind/mode/action 为 rush 且含 order_id，必须玩家原话明确要求该密令“催办/加急/限期/本月即核”，才可 allow=true，kind="rush"，phase=confirm。只是问“要不要暗查”“查得如何”“此事能否密办”“何时能办完”、NPC 自行建议密查或催办，必须 false。
